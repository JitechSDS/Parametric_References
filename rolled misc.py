...
# startup code end
# member begin
memadd541 = Member('Misc Rolled Section')
memadd541.LeftEnd.Location = PointLocate('Select point')
memadd541.RightEnd.Location = PointLocate('Select point')
memadd541.SectionSize = 'L4x3x1/2'
memadd541.MaterialGrade = 'A36'
memadd541.TopOperationTypeLeftEnd = 'None'
memadd541.TopOperationTypeRightEnd = 'None'
memadd541.BottomOperationTypeLeftEnd = 'None'
memadd541.BottomOperationTypeRightEnd = 'None'
memadd541.RollType = 'Weak axis'
memadd541.MaterialSetbackLeftEnd = 6
memadd541.MaterialSetbackRightEnd = 0
memadd541.MaterialType = 'Angle'
memadd541.SurfaceFinish = 'None'
memadd541.MaterialColor3d = 'Medium_beam'
memadd541.Add()
memadd541.Rotate((6.392463, 0.000000, 180.000000))
# member end
